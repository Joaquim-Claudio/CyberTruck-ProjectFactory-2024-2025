...
class Param {
    public:
        ...
        static const uint8_t MOTOR_RIGHT_CHANNEL_1;
        static const uint8_t MOTOR_RIGHT_CHANNEL_2;
        static const uint8_t MOTOR_LEFT_CHANNEL_1;
        static const uint8_t MOTOR_LEFT_CHANNEL_2;
        ...
        static const char* DISTANCE_TOPIC;
